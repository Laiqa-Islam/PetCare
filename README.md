...
| Pet owner | `owner2@furshield.test` |
| Pet owner | `owner3@furshield.test` |
| Veterinarian | `vet@furshield.test` |
| Veterinarian — dermatology | `vet.derm@furshield.test` |
| Veterinarian — exotic pets | `vet.exotic@furshield.test` |
| Veterinarian — surgery | `vet.surgery@furshield.test` |
| Animal shelter | `shelter@furshield.test` |
| Animal shelter | `shelter.haven@furshield.test` |
| Animal shelter | `shelter.rescue@furshield.test` |
