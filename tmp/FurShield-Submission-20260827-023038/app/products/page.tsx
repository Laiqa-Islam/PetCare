...
export default async function ProductsPage() {
  ...
  return <PublicShell><section className="page-hero"><div className="shell"><p className="eyebrow">Pet essentials</p><h1>Useful things, chosen with care.</h1><p>Browse food, grooming, toys, accessories, health supplies, and training aids. FurShield intentionally does not process payments or physical delivery.</p></div></section><section className="content-section shell"><ProductCatalog items={items}/></section></PublicShell>;
}
