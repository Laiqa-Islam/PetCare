...
def build_report():
    ...
    diagram(arch, "Role-aware application architecture", [
        ...
        (1090, 540, 315, 120, "Resend (optional)\nemail channel", "#F6F8F8"),
    ...
    steps(doc, [
        ...
        "Copy .env.example to .env.local and fill MongoDB, Cloudinary, and SESSION_SECRET values. Resend variables are optional.",
    ...
    matrix(doc, ["Item", "Local state", "Release action"], [
        ...
        ("Email delivery", "Adapter implemented; optional", "Add verified sender and Resend API key if email is required"),
...
def build_readme():
    ...
    bullets(doc, ["Node.js 20 or newer and npm", "MongoDB Atlas connection string", "Cloudinary cloud name, API key, and API secret", "Optional Resend key and verified sender for email delivery"])
    ...
    matrix(doc, ["Variable", "Required", "Purpose"], [
        ...
        ("RESEND_API_KEY", "No", "Shelter decision email delivery"),
        ("EMAIL_FROM", "No", "Verified email sender identity"),
    ], [3400, 1200, 4760])
    ...
    matrix(doc, ["Symptom", "Resolution"], [
        ...
        ("No email received", "In-app alerts still work. Configure Resend and a verified EMAIL_FROM sender."),
